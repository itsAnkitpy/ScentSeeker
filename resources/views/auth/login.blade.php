...
@section('content')
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="absolute bottom-20 left-10 w-24 h-24 bg-purple-200 rounded-full opacity-30 animate-pulse delay-1000">
        </div>
        <div class="absolute top-1/2 right-1/4 w-16 h-16 bg-indigo-200 rounded-full opacity-25 animate-pulse delay-500">
        </div>
                            ...
                            <div x-show="showForgotModal" x-cloak
                                ...
                                <div class="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl" @click.stop>
                                    ...
                                    <input type="email" x-model="resetEmail" placeholder="your@email.com"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 mb-4 focus:border-pink-400 focus:ring-2 focus:ring-pink-200">
                                    ...
                                    <div class="flex gap-3">
                                        <button type="button" @click="sendResetLink()" :disabled="resetLoading"
                                            class="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white py-2 rounded-xl font-medium hover:from-pink-600 hover:to-purple-700 disabled:opacity-50">
