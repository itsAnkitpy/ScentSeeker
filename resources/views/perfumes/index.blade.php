        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="mb-16 text-center">
                ...
                <p class="text-xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed">
                    Browse through our curated collection of exquisite fragrances and discover the best deals from premium
                    retailers
                </p>
                                ...
                                <div class="flex items-center gap-2">
                                    <div
                                        ...
                                        <svg class="w-4 h-4 text-white transition-transform"
                                            :class="{'rotate-180': showMobileFilters}" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                        ...
                        <div class="bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/60 sticky top-24 space-y-8"
                            ...
                            <div class="flex items-center justify-between pb-4 border-b border-gray-100">
                                ...
                                <button @click="clearFilters()"
                                    class="text-sm text-pink-600 hover:text-pink-700 font-semibold bg-pink-50 hover:bg-pink-100 px-4 py-2 rounded-full transition-all">
                                    Clear All
                                </button>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-6">
                                    ...
                                    <div class="space-y-4">
                                        <div
                                            class="flex items-center justify-between text-sm font-semibold text-gray-700 bg-white/80 rounded-xl px-4 py-2">
                                            <span
                                                class="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">₹<span
                                                    x-text="filters.priceRange[0].toLocaleString()"></span></span>
                                        ...
                                        <div class="relative py-4">
                                            <input type="range" x-model="filters.priceRange[0]" min="0" max="15000"
                                                step="500" @input="applyFilters()"
                                                class="absolute w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider-thumb">
                                            <input type="range" x-model="filters.priceRange[1]" min="0" max="15000"
                                                step="500" @input="applyFilters()"
                                                class="absolute w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider-thumb">
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6">
                                    ...
                                    <div class="space-y-4">
                                        <template
                                            x-for="brand in ['Chanel', 'Dior', 'Tom Ford', 'Jo Malone', 'Gucci', 'Yves Saint Laurent', 'Clean', 'Hermès']">
                                            <label
                                                class="flex items-center group cursor-pointer bg-white/80 hover:bg-white rounded-xl p-3 transition-all hover:shadow-md">
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        class="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity">
                                                    </div>
                                                </div>
                                                <span
                                                    class="ml-4 text-sm font-medium text-gray-700 group-hover:text-pink-600 transition-colors"
                                                    x-text="brand"></span>
                                            </label>
                                        </template>
                                    </div>
                                        ...
                                        <template x-for="season in ['Spring', 'Summer', 'Fall', 'Winter']">
                                            <label
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        class="absolute inset-0 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity">
                                                    </div>
                                                </div>
                                                <span
                                                    class="ml-2 text-xs font-medium text-gray-700 group-hover:text-green-600 transition-colors"
                                                    x-text="season"></span>
                                            </label>
                                        </template>
                                    </div>
                                        ...
                                        <template x-for="conc in ['EDP', 'EDT', 'Parfum', 'Cologne', 'Extrait']">
                                            <label
                                                ...
                                                <input type="checkbox" :checked="filters.concentrations.includes(conc)"
                                                    @change="toggleFilter('concentrations', conc)"
                                                    class="w-5 h-5 text-amber-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-amber-500 focus:ring-2 transition-all">
                                                <span
                                                    class="ml-2 text-xs font-medium text-gray-700 group-hover:text-amber-600 transition-colors"
                                                    x-text="conc"></span>
                                            </label>
                                        </template>
                                    </div>
                            ...
                            <!-- Gender Filter -->
                            <div class="space-y-6">
                                <div class="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-6">
                                    <h4 class="font-bold text-gray-800 mb-6 flex items-center gap-2">
                                        ...
                                        <template x-for="gender in ['Male', 'Female', 'Unisex']">
                                            <label
                                                ...
                                                <input type="checkbox" :checked="filters.genders.includes(gender)"
                                                    @change="toggleFilter('genders', gender)"
                                                    class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all">
                                                <span
                                                    class="ml-2 text-xs font-medium text-gray-700 group-hover:text-purple-600 transition-colors"
                                                    x-text="gender"></span>
                                            </label>
                                        </template>
                                    </div>
                            ...
                            <!-- Size Filter -->
                            <div class="space-y-6">
                                <div class="bg-gradient-to-r from-cyan-50 to-teal-50 rounded-2xl p-6">
                                    <h4 class="font-bold text-gray-800 mb-6 flex items-center gap-2">
                                        ...
                                        <template x-for="size in [30, 50, 100, 150, 200]">
                                            <label
                                                ...
                                                <input type="checkbox" :checked="filters.sizes.includes(size)"
                                                    ...
                                                    class="w-5 h-5 text-cyan-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-cyan-500 focus:ring-2 transition-all">
                                                <span
                                                    class="ml-2 text-xs font-medium text-gray-700 group-hover:text-cyan-600 transition-colors"
                                                    x-text="size + 'ml'"></span>
                                            </label>
                                        </template>
                                    </div>
                    ...
                    <div class="flex-1 space-y-10">
                        ...
                        <div class="bg-white/70 backdrop-blur-xl rounded-3xl p-8 border border-white/40 shadow-2xl">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                                ...
                                <div class="relative flex-grow md:flex-grow-0 md:w-80">
                                    <input type="text" x-model.debounce.500ms="searchTerm" @input="fetchPerfumes(1)"
                        ...
                        <template x-if="isLoading">
                            <div class="flex justify-center items-center py-32">
                                <div class="relative">
                                    <div
                                        class="animate-spin rounded-full h-20 w-20 border-4 border-pink-200 border-t-pink-600">
                                    </div>
                        ...
                        <template x-if="error">
                            <div class="text-center py-32">
                                <div class="bg-red-50 border-2 border-red-200 rounded-3xl p-12 max-w-lg mx-auto shadow-xl">
                                    ...
                                    <button @click="fetchPerfumes()"
                                        class="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-2xl font-semibold transition-all">
                                        Try Again
                                    </button>
                                </div>
                            </div>
                        ...
                        <template x-if="!isLoading && !error && perfumes.length === 0">
                            <div class="text-center py-32">
                                <div
                                    class="bg-gray-50 border-2 border-gray-200 rounded-3xl p-12 max-w-lg mx-auto shadow-xl">
                                    <div
                                        class="w-16 h-16 mx-auto mb-6 bg-gray-100 rounded-full flex items-center justify-center">
                                    ...
                                    <p class="text-gray-600 mb-8">Try adjusting your filters or search criteria to discover
                                        more fragrances</p>
                                    <button @click="clearFilters()"
                                        class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold hover:from-pink-600 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg">
                                        Clear All Filters
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="space-y-12">
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                                    <template x-for="perfume in perfumes" :key="perfume.id">
                                        <div
                                            class="group bg-white/85 backdrop-blur-xl rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-white/60 hover:border-white/80">
                                            <!-- Image Container -->
                                            <div class="relative overflow-hidden h-40">
                                                ...
                                                <div class="absolute top-3 left-3">
                                                    <span
                                                        class="px-3 py-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-xs font-bold rounded-full shadow-lg backdrop-blur-sm">
                                                ...
                                                <!-- Wishlist Button -->
                                                <button
                                                    class="absolute top-3 right-3 w-8 h-8 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0 hover:bg-pink-500 hover:text-white shadow-lg hover:shadow-xl">
                                            ...
                                            <div class="p-4 space-y-3">
                                                <div class="space-y-1">
                                                    <p class="text-xs font-bold text-pink-600 uppercase tracking-wide"
                                                        x-text="perfume.brand"></p>
                                                    <h3 class="text-base font-bold text-gray-800 line-clamp-2 leading-tight"
                                                        x-text="perfume.name"></h3>
                                                </div>
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            <span class="text-xl font-bold text-gray-900">
                                                                ₹<span
                                                                    x-text="(perfume.min_price || '4,999').toLocaleString()"></span>
                                                            </span>
                                                        ...
                                                        <div
                                                            class="w-8 h-8 bg-gradient-to-r from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-md">
                                                    ...
                                                    <div class="bg-gray-50 rounded-xl p-3 space-y-1 text-xs">
                                                        <div class="flex justify-between text-gray-700">
                                                            ...
                                                            <span class="font-bold text-green-600">₹<span
                                                                    x-text="(perfume.min_price || '4,999').toLocaleString()"></span></span>
                                                        </div>
                                                        <div class="flex justify-between text-gray-600">
                                                            <span>Perfume World</span>
                                                            <span>₹<span
                                                                    x-text="(parseInt(perfume.min_price || '4999') + 300).toLocaleString()"></span></span>
                                                        </div>
                                                        <template x-if="(perfume.seller_count || 3) > 2">
                                                            <div
                                                                class="text-pink-600 font-bold text-center pt-1 border-t border-gray-200">
                                                                +<span x-text="(perfume.seller_count || 3) - 2"></span> more
                                                                sellers
                                                            </div>
                                                        </template>
                                                    </div>
                                ...
                                <div class="pt-8" x-show="pagination && pagination.last_page > 1">
                                    <nav class="flex items-center justify-center">
                                        <div
                                            class="flex items-center space-x-3 bg-white/80 backdrop-blur-xl rounded-3xl p-4 shadow-xl border border-white/50">
                                            <!-- Previous Button -->
                                            ...
                                            <!-- Page Numbers -->
                                            <template
                                                x-for="page in Array.from({length: Math.min(5, pagination.last_page)}, (_, i) => i + Math.max(1, currentPage - 2))">
                                                <button @click="fetchPerfumes(page)" :class="{
