            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        <a href="/" class="flex items-center space-x-2">
                            <div
                                class="w-8 h-8 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center">
                    ...
                    <nav class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="{{ route('perfumes.index') }}"
                            class="text-gray-700 hover:text-pink-600 font-medium transition-colors">Browse</a>
                    ...
                    <div class="flex items-center space-x-4">
                            ...
                            <template x-if="!user">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-lg font-medium hover:from-pink-600 hover:to-purple-700 transition-all transform hover:scale-105">
                                        Sign Up
                                    </a>
                                </div>
                            </template>
                            ...
                            <template x-if="user">
                                <div class="relative">
                                    <button @click="isOpen = !isOpen" @click.outside="isOpen = false"
                                        class="flex items-center space-x-2 bg-gradient-to-r from-pink-50 to-purple-50 hover:from-pink-100 hover:to-purple-100 px-4 py-2 rounded-xl border border-pink-200 transition-all">
                                        <div
                                            class="w-8 h-8 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                            <span
                        ...
                        <!-- Mobile menu button -->
                        <div class="md:hidden">
                            <button type="button" class="text-gray-600 hover:text-pink-600 transition-colors" x-data
                ...
                <div class="md:hidden hidden" x-ref="mobileMenu">
                    <div class="px-2 pt-2 pb-3 space-y-1 bg-white/90 backdrop-blur-lg rounded-lg mt-2 border border-white/20"
                        ...
                        <a href="{{ route('perfumes.index') }}"
                            class="block px-3 py-2 text-gray-700 hover:text-pink-600 font-medium">Browse</a>
                        ...
                        <div class="border-t border-gray-200 pt-2 mt-2">
                            ...
                            <template x-if="!user">
                                <div>
                                    <a href="{{ route('login') }}"
                                        class="block px-3 py-2 text-gray-700 hover:text-pink-600 font-medium">Login</a>
                                    <a href="{{ route('register') }}"
                                        class="block px-3 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-medium mx-3 text-center mt-2">Sign
                                        Up</a>
                                </div>
                            </template>
                            ...
                            <template x-if="user">
                                <div>
                                    <div class="flex items-center px-3 py-2 mb-2">
                                        <div
                                            class="w-8 h-8 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm mr-2">
                                            <span
                                                x-text="user.username ? user.username.charAt(0).toUpperCase() : 'U'"></span>
                                        </div>
                                        <div>
                                    ...
                                    <a href="#"
                                        class="block px-3 py-2 text-gray-700 hover:text-pink-600 font-medium">Wishlist</a>
                                    <a href="#"
                                        class="block px-3 py-2 text-gray-700 hover:text-pink-600 font-medium">Price
                                        Alerts</a>
                                    <button @click="logout()"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Browse
                                    Perfumes</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Price
                                    Comparison</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Best Deals</a>
                            </li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">New Arrivals</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Help Center</a>
                            </li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Contact Us</a>
                            </li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Privacy
                                    Policy</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-pink-600 transition-colors">Terms of
                                    Service</a></li>
                        </ul>
                    </div>
                </div>
